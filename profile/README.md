...
| Wenjie Dong | [@Explorer-Dong](https://github.com/Explorer-Dong) / [Wenjie Dong's HomePage](https://www.dwj601.cn/) |
...
| [open-csai-wiki](https://github.com/Explorer-Dong/open-csai-wiki) | [Open CS/AI Wiki Team](https://github.com/Explorer-Dong/open-csai-wiki/graphs/contributors) | 技术博客 / 知识库 | 一个围绕计算机与人工智能的知识库，内容覆盖基础 CS/AI 知识、数据结构与算法、软件开发和大模型等方向。 |
...
如需加入 RunminG-Lab，或希望一起维护 AI、软件工程、Vibe Coding 等相关项目，请联系 [@TsingPig](https://github.com/TsingPig)。
